...
constant integer si__assert=8
constant integer si__hardware=9
...
constant integer si__escStack=12
...
constant integer si__uiEventState=13
boolean s__uiEventState_rcStart=false
integer s__uiEventState_uiId=0
constant integer si__uiBorder=14
...
constant integer si__menuItem=18
...
integer array s__menuItem_highlight
integer array s__menuItem_index
integer array s__menuItem_parent
constant integer si__mouseMenu=19
...
function sc___prototype21_execute takes integer i,player a1 returns nothing
    set f__arg_player1=a1

    call TriggerExecute(st___prototype21[i])
endfunction
function sc___prototype21_evaluate takes integer i,player a1 returns nothing
    set f__arg_player1=a1

    call TriggerEvaluate(st___prototype21[i])

endfunction
function sc___prototype22_execute takes integer i,integer a1 returns nothing
    set f__arg_integer1=a1

    call TriggerExecute(st___prototype22[i])
endfunction
function sc___prototype22_evaluate takes integer i,integer a1 returns nothing
    set f__arg_integer1=a1
...
//processed:     function interface escStackFunc takes player arg0 returns nothing
        ...
        function s__escStack_pop takes nothing returns boolean
            ...
            call sc___prototype21_evaluate(s__EscStack___EscStackData_func[data],GetLocalPlayer())
...
//processed:     function interface uiEvent takes integer arg0 returns nothing
        function UIExtendEvent___anon__3 takes nothing returns nothing
            ...
            if ( HaveSavedInteger(HASH_UI, currentUI, 1901) ) then
                ...
                call sc___prototype22_evaluate(func,currentUI)
            endif
        ...
        function UIExtendEvent___anon__6 takes nothing returns nothing
            ...
            if ( s__uiEventState_rcStart and s__uiEventState_uiId != 0 ) then
                if ( HaveSavedInteger(HASH_UI, s__uiEventState_uiId, 1913) ) then
                    ...
                    call sc___prototype22_evaluate(func,s__uiEventState_uiId)
                endif
            endif
        ...
        function s__uiBtn_exLeftUp takes integer this,integer func returns integer
            ...
            function s__uiBtn_extendEvent___anon__0 takes nothing returns nothing
                ...
                if ( HaveSavedInteger(HASH_UI, frame, 1910) ) then
                    ...
                    call sc___prototype22_evaluate(func,frame)
                endif
            endfunction
...
//processed:     function interface menuEventFunc takes integer arg0 returns nothing
        ...
        function s__menuItem_onDestroy takes integer this returns nothing
            ...
            if ( s__menuItem_highlight[this] != 0 ) then
                call s__uiImage_deallocate(s__menuItem_highlight[this])
                set s__menuItem_highlight[this]=0
            endif
...
function s__menuItem_deallocate takes integer this returns nothing
    ...
    set si__menuItem_F=this
        ...
        function s__menuItem_showHighlight takes integer this,boolean show returns nothing
            if ( s__menuItem_highlight[this] != 0 ) then
                call s__uiImage_show(s__menuItem_highlight[this],show)
            endif
        endfunction
        function s__menuItem_create takes integer parent,string title,integer index,integer parentFrame returns integer
            local integer this=s__menuItem__allocate()
            set s__menuItem_parent[this]=parent
            set s__menuItem_index[this]=index
            set s__menuItem_background[this]=s__uiBorder_setSizeFix(s__uiBorder_createType2(parentFrame),s__mouseMenu_menuWidth[parent] , 0.03)
            set s__menuItem_text[this]=s__uiText_setText(s__uiText_setPoint(s__uiText_setAlign(s__uiText_create(parentFrame),4),3 , s__uiBorder_ui[s__menuItem_background[this]] , 3 , 0.01 , 0),title)
            set s__menuItem_highlight[this]=s__uiImage_show(s__uiImage_setAllPoint(s__uiImage_setTexture(s__uiImage_create(parentFrame),"ui\\image\\buttongrow.blp"),s__uiBorder_ui[s__menuItem_background[this]]),false)
        ...
        function s__mouseMenu_getFirstItem takes integer this returns integer
            if ( s___mouseMenu_items[s__mouseMenu_items[this]+1] == 0 ) then
                set s___mouseMenu_items[s__mouseMenu_items[this]+1]=s__menuItem_create(this , null , 1 , s__uiImage_ui[s__mouseMenu_menuFrame[this]])
                set s__mouseMenu_itemCount[this]=1
            endif
            return s___mouseMenu_items[s__mouseMenu_items[this]+1]
        endfunction
        ...
        function s__mouseMenu_onDestroy takes integer this returns nothing
            ...
            loop
            exitwhen ( i > s__mouseMenu_itemCount[this] )
                if ( s___mouseMenu_items[s__mouseMenu_items[this]+i] != 0 ) then
...
function s__mouseMenu_deallocate takes integer this returns nothing
    ...
    set si__mouseMenu_F=this
            ...
            function s__mouseMenu_anon__0 takes integer frame returns nothing
                ...
                if ( s__mouseMenu_onEnterFunc[this] != null ) then
                    call s__menuItem_showHighlight(s___mouseMenu_items[s__mouseMenu_items[this]+index],true)
                    call sc___prototype22_evaluate(s__mouseMenu_onEnterFunc[this],index)
                endif
            endfunction
            function s__mouseMenu_anon__1 takes integer frame returns nothing
                ...
                if ( s__mouseMenu_onLeaveFunc[this] != null ) then
                    call s__menuItem_showHighlight(s___mouseMenu_items[s__mouseMenu_items[this]+index],false)
                    call sc___prototype22_evaluate(s__mouseMenu_onLeaveFunc[this],index)
                endif
            endfunction
            function s__mouseMenu_anon__2 takes integer frame returns nothing
                ...
                if ( s__mouseMenu_onClickFunc[this] != null ) then
                    call sc___prototype22_evaluate(s__mouseMenu_onClickFunc[this],index)
                endif
        ...
        function s__mouseMenu_AddMenuItem takes integer this,string title returns integer
            ...
            set s___mouseMenu_items[s__mouseMenu_items[this]+s__mouseMenu_itemCount[this]]=s__menuItem_create(this , title , s__mouseMenu_itemCount[this] , s__uiImage_ui[s__mouseMenu_menuFrame[this]])
            ...
            elseif ( s__mouseMenu_isUpward[this] ) then
                call s__uiBorder_setPoint(s__menuItem_background[s___mouseMenu_items[s__mouseMenu_items[this]+s__mouseMenu_itemCount[this]]],7 , s__uiBorder_ui[s__menuItem_background[s___mouseMenu_items[s__mouseMenu_items[this]+s__mouseMenu_itemCount[this] - 1]]] , 1 , 0 , 0)
            else
                call s__uiBorder_setPoint(s__menuItem_background[s___mouseMenu_items[s__mouseMenu_items[this]+s__mouseMenu_itemCount[this]]],1 , s__uiBorder_ui[s__menuItem_background[s___mouseMenu_items[s__mouseMenu_items[this]+s__mouseMenu_itemCount[this] - 1]]] , 7 , 0 , 0)
            endif
            ...
            call s__uiImage_setSizeFix(s__mouseMenu_menuFrame[this],s__mouseMenu_menuWidth[this] , s__mouseMenu_itemCount[this] * 0.03)
            return this
        endfunction
        function s__mouseMenu_create takes integer parent,boolean isUpward,real width returns integer
            ...
            set s__mouseMenu_menuFrame[this]=s__uiImage_show(s__uiImage_setSizeFix(s__uiImage_setTexture(s__uiImage_create(parent),"UI\\Widgets\\EscMenu\\Human\\blank-background.blp"),width , 0.03),false)
            return this
        endfunction
            function s__mouseMenu_anon__3 takes nothing returns nothing
        ...
        function s__mouseMenu_onInit takes nothing returns nothing
            call s__hardware_regLeftUpEvent(function s__mouseMenu_anon__3)
        endfunction
            function s__mouseMenu_anon__4 takes player p returns nothing
                call sc__mouseMenu_show(s__mouseMenu_currentMenu,false)
            endfunction
...
//library UTMouseMenu:
        ...
        function UTMouseMenu___anon__0 takes nothing returns nothing
        endfunction  //end
        function UTMouseMenu___anon__1 takes nothing returns nothing
        endfunction
        function UTMouseMenu___anon__2 takes nothing returns nothing
        endfunction  //menuItem.create
    function UTMouseMenu___Init takes nothing returns nothing
        call UnitTestAutoTimer(0.1 , 2.0 , function UTMouseMenu___anon__0 , function UTMouseMenu___anon__1)
        call UnitTestAutoTimer(0.1 , 2.0 , function UTMouseMenu___anon__2 , null)
    endfunction
        function UTMouseMenu___anon__3 takes integer index returns nothing
            call BJDebugMsg("[进入事件] " + I2S(index))
        endfunction
        function UTMouseMenu___anon__4 takes integer index returns nothing
            call BJDebugMsg("[点击事件] " + I2S(index))
        endfunction
        function UTMouseMenu___anon__5 takes integer index returns nothing
            call BJDebugMsg("[离开事件] " + I2S(index))
        endfunction
    function UTMouseMenu___TTestUTMouseMenu1 takes player p returns nothing
        if ( not ( s__mouseMenu_isExist(UTMouseMenu___menu) ) ) then
            set UTMouseMenu___menu=s__mouseMenu_create(DzGetGameUI() , true , 0.08)
            call s__mouseMenu_onEnter(UTMouseMenu___menu,(4))
            call s__mouseMenu_onClick(UTMouseMenu___menu,(5))
            call s__mouseMenu_onLeave(UTMouseMenu___menu,(6))
            call s__mouseMenu_AddMenuItem(UTMouseMenu___menu,"测试1")
            call s__mouseMenu_AddMenuItem(UTMouseMenu___menu,"测试2")
            call s__mouseMenu_AddMenuItem(UTMouseMenu___menu,"测试3")
            call s__mouseMenu_AddMenuItem(UTMouseMenu___menu,"测试4")
            call s__mouseMenu_AddMenuItem(UTMouseMenu___menu,"测试5")
            call s__uiImage_setAbsPoint(s__mouseMenu_menuFrame[UTMouseMenu___menu],4 , 0.4 , 0.3)
            call BJDebugMsg("创建菜单")
        endif
        call s__mouseMenu_show(UTMouseMenu___menu,true)
    endfunction
    function UTMouseMenu___TTestUTMouseMenu2 takes player p returns nothing
        call s__uiBorder_setAbsPoint(s__uiBorder_setSizeFix(s__uiBorder_createType2(DzGetGameUI()),0.2 , 0.05),4 , 0.4 , 0.3)
    endfunction
    ...
    function UTMouseMenu___TTestActUTMouseMenu1 takes string str returns nothing
        ...
        function UTMouseMenu___anon__6 takes nothing returns nothing
            call BJDebugMsg("[MouseMenu] 单元测试已加载")
            call UTMouseMenu___Init()
            call DestroyTrigger(GetTriggeringTrigger())
        endfunction
        function UTMouseMenu___anon__7 takes nothing returns nothing
    ...
    function UTMouseMenu___onInit takes nothing returns nothing
        ...
        call TriggerAddCondition(tr, Condition(function UTMouseMenu___anon__6))
        set tr=null
        call UnitTestRegisterChatEvent(function UTMouseMenu___anon__7)
    endfunction
...
call ExecuteFunc("jasshelper__initstructs33147718")
...
function sa___prototype22_UTMouseMenu___anon__3 takes nothing returns boolean
 local integer index=f__arg_integer1

            call BJDebugMsg("[进入事件] " + I2S(index))
    return true
endfunction
function sa___prototype22_UTMouseMenu___anon__4 takes nothing returns boolean
 local integer index=f__arg_integer1

            call BJDebugMsg("[点击事件] " + I2S(index))
    return true
endfunction
function sa___prototype22_UTMouseMenu___anon__5 takes nothing returns boolean
 local integer index=f__arg_integer1

            call BJDebugMsg("[离开事件] " + I2S(index))
    return true
endfunction
function sa___prototype22_s__mouseMenu_anon__0 takes nothing returns boolean
...
function sa___prototype22_s__mouseMenu_anon__1 takes nothing returns boolean
 local integer frame=f__arg_integer1
...
function sa___prototype22_s__mouseMenu_anon__2 takes nothing returns boolean
 local integer frame=f__arg_integer1
...
function sa___prototype21_s__mouseMenu_anon__4 takes nothing returns boolean
...
function jasshelper__initstructs33147718 takes nothing returns nothing
    ...
    set st___prototype22[4]=CreateTrigger()
    call TriggerAddAction(st___prototype22[4],function sa___prototype22_UTMouseMenu___anon__3)
    call TriggerAddCondition(st___prototype22[4],Condition(function sa___prototype22_UTMouseMenu___anon__3))
    set st___prototype22[5]=CreateTrigger()
    call TriggerAddAction(st___prototype22[5],function sa___prototype22_UTMouseMenu___anon__4)
    call TriggerAddCondition(st___prototype22[5],Condition(function sa___prototype22_UTMouseMenu___anon__4))
    set st___prototype22[6]=CreateTrigger()
    call TriggerAddAction(st___prototype22[6],function sa___prototype22_UTMouseMenu___anon__5)
    call TriggerAddCondition(st___prototype22[6],Condition(function sa___prototype22_UTMouseMenu___anon__5))
    set st___prototype22[1]=CreateTrigger()
    call TriggerAddAction(st___prototype22[1],function sa___prototype22_s__mouseMenu_anon__0)
    call TriggerAddCondition(st___prototype22[1],Condition(function sa___prototype22_s__mouseMenu_anon__0))
    set st___prototype22[2]=CreateTrigger()
    call TriggerAddAction(st___prototype22[2],function sa___prototype22_s__mouseMenu_anon__1)
    call TriggerAddCondition(st___prototype22[2],Condition(function sa___prototype22_s__mouseMenu_anon__1))
    set st___prototype22[3]=CreateTrigger()
    call TriggerAddAction(st___prototype22[3],function sa___prototype22_s__mouseMenu_anon__2)
    call TriggerAddCondition(st___prototype22[3],Condition(function sa___prototype22_s__mouseMenu_anon__2))
    set st___prototype21[1]=CreateTrigger()
    call TriggerAddAction(st___prototype21[1],function sa___prototype21_s__mouseMenu_anon__4)
    call TriggerAddCondition(st___prototype21[1],Condition(function sa___prototype21_s__mouseMenu_anon__4))
