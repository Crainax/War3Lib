            ...
            function s__mallItem_anon__0 takes nothing returns nothing
                ...
                exitwhen ( pid >= 4 )
                    ...
                    exitwhen ( idx >= n )
                        ...
                        set s__mallItem_owns[base + idx]=4
...
//library UTMallItem:
    ...
    function UTMallItem__DumpState takes player p returns nothing
        ...
        endloop
            ...
            function UTMallItem__anon__1 takes nothing returns boolean
        ...
        function UTMallItem__anon__0 takes nothing returns boolean
            ...
            call s__mallItem_consumeTimes(p0 , "VIP1" , 1 , function UTMallItem__anon__1)
    ...
    function UTMallItem__Init takes nothing returns nothing
        ...
        call s__mallItem_onReady(function UTMallItem__anon__0)
    ...
    function UTMallItem__TTestUTMallItem10 takes player p returns nothing
        ...
        function UTMallItem__anon__4 takes nothing returns boolean
            local player cbp=s__mallItem_getCallbackPlayer()
    ...
    function UTMallItem__TTestActUTMallItem1 takes string str returns nothing
        ...
        elseif ( paramS[0] == "ct" ) then
            if ( num >= 3 ) then
                call s__mallItem_consumeTimes(p , paramS[1] , paramI[2] , function UTMallItem__anon__4)
            else
        ...
        function UTMallItem__anon__5 takes nothing returns nothing
...
call ExecuteFunc("jasshelper__initstructs276634500")
...
function jasshelper__initstructs276634500 takes nothing returns nothing
