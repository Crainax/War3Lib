...
//library UTMallItem:
        ...
        function UTMallItem___anon__0 takes nothing returns nothing
        endfunction  //end,这里是2秒后调用的内容
        function UTMallItem___anon__1 takes nothing returns nothing
        endfunction
        function UTMallItem___anon__2 takes nothing returns nothing
        endfunction
    function UTMallItem___Init takes nothing returns nothing
        call UnitTestAutoTimer(0.1 , 2.0 , function UTMallItem___anon__0 , function UTMallItem___anon__1)
        call UnitTestAutoTimer(0.1 , 2.0 , function UTMallItem___anon__2 , null)
    endfunction
    ...
    function UTMallItem___TTestActUTMallItem1 takes string str returns nothing
        ...
        function UTMallItem___anon__4 takes nothing returns nothing
    ...
    function UTMallItem___onInit takes nothing returns nothing
        ...
        call TriggerAddCondition(tr, Condition(function UTMallItem___anon__3))
        set tr=null
        call UnitTestRegisterChatEvent(function UTMallItem___anon__4)
    endfunction
...
call ExecuteFunc("jasshelper__initstructs263155390")
...
function jasshelper__initstructs263155390 takes nothing returns nothing
