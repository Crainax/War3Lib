...
constant boolean LIBRARY_UTUIImage=true
    uiImage UTUIImage___currentImage=0
...
//library UIBaseModule:
    module uiBaseModule  // 设置位置
        ...
        method clearPoint takes nothing returns thistype
            ...
            return this
        endmethod  // 设置大小
        method size takes real width,real height returns thistype
            if (not (this.isExist()))then
                return this
            endif
...
//library UIImage:
    ...
    //! pragma implicitthis
        ...
        implement  uiImageModule
        static method create takes integer parent returns thistype  // 创建文本 // parent: 父级框架
...
//library UTUIImage:
    ...
    function UTUIImage___TTestUTUIImage1 takes player p returns nothing
        if (GetLocalPlayer()==p)then
            set UTUIImage___currentImage=uiImage.create(DzGetGameUI()).size(0.04,0.04).setPoint(4,DzGetGameUI(),4,0.0,0.0).texture("ReplaceableTextures\\CommandButtons\\BTNKeeperOfTheGrove.blp")
    ...
    function UTUIImage___TTestUTUIImage4 takes player p returns nothing
        if (GetLocalPlayer()==p)then
            if (UTUIImage___currentImage!=0)then
                call UTUIImage___currentImage.destroy()
    ...
    function UTUIImage___TTestUTUIImage5 takes player p returns nothing
        if (GetLocalPlayer()==p)then
            ...
            set UTUIImage___currentImage=uiImage.createToolTips(DzGetGameUI()).size(0.3,0.4).setPoint(4,DzGetGameUI(),4,0.0,0.0)
    ...
    function UTUIImage___TTestUTUIImage6 takes player p returns nothing
        if (GetLocalPlayer()==p)then
            ...
            set UTUIImage___currentImage=uiImage.createToolTips2(DzGetGameUI()).size(0.3,0.4).setPoint(4,DzGetGameUI(),4,0.0,0.0)
    ...
    function UTUIImage___TTestUTUIImage7 takes player p returns nothing
        if (GetLocalPlayer()==p)then
            ...
            set UTUIImage___currentImage=uiImage.createToolTips3(DzGetGameUI()).size(0.3,0.4).setPoint(4,DzGetGameUI(),4,0.0,0.0)
    ...
    function UTUIImage___TTestActUTUIImage1 takes string str returns nothing
        ...
        function UTUIImage___anon__0 takes nothing returns nothing  //在游戏开始0.5秒后再调用
