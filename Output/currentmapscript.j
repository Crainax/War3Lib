...
constant integer si__unitAttr=2
...
//library UTUnitAttr:
    ...
    function UTUnitAttr___CreateTestUnit takes player p returns nothing
        if ( UTUnitAttr___testUnit != null ) then
            call RemoveUnit(UTUnitAttr___testUnit)
        endif // 使用步兵作为测试单位
    ...
    function UTUnitAttr___TTestUTUnitAttr1 takes player p returns nothing
        ...
        call BJDebugMsg("初始基础HP: " + R2S(s__unitAttr_getCurrentHP(UTUnitAttr___testAttr)))
        call s__unitAttr_addHP(UTUnitAttr___testAttr,50)
        call BJDebugMsg("增加50点HP后: " + R2S(s__unitAttr_getCurrentHP(UTUnitAttr___testAttr)))
        call s__unitAttr_addHP(UTUnitAttr___testAttr,- 30)
        call BJDebugMsg("减少30点HP后: " + R2S(s__unitAttr_getCurrentHP(UTUnitAttr___testAttr)))
    endfunction  // 测试HP增幅比例
    function UTUnitAttr___TTestUTUnitAttr2 takes player p returns nothing
        call UTUnitAttr___CreateTestUnit(p)
        call BJDebugMsg("测试2开始: HP增幅比例测试")
        call BJDebugMsg("初始HP: " + R2S(s__unitAttr_getCurrentHP(UTUnitAttr___testAttr))) // 增加50%
        call s__unitAttr_addHPRateUp(UTUnitAttr___testAttr,0.5)
        call BJDebugMsg("增加50%增幅后: " + R2S(s__unitAttr_getCurrentHP(UTUnitAttr___testAttr)))
    ...
    function UTUnitAttr___TTestUTUnitAttr3 takes player p returns nothing
        ...
        call BJDebugMsg("初始HP: " + R2S(s__unitAttr_getCurrentHP(UTUnitAttr___testAttr))) // 减少30%
        call s__unitAttr_addHPRateDown(UTUnitAttr___testAttr,0.3)
        call BJDebugMsg("增加30%减幅后: " + R2S(s__unitAttr_getCurrentHP(UTUnitAttr___testAttr)))
        call BJDebugMsg("当前HP倍率: " + R2S(s__unitAttr_getCurrentHPRate(UTUnitAttr___testAttr)))
    ...
    function UTUnitAttr___TTestUTUnitAttr4 takes player p returns nothing
        ...
        call BJDebugMsg("初始HP: " + R2S(s__unitAttr_getCurrentHP(UTUnitAttr___testAttr))) // 增加50%
        call s__unitAttr_addHPRateUp(UTUnitAttr___testAttr,0.5) // 减少20%
        call s__unitAttr_addHPRateDown(UTUnitAttr___testAttr,0.2)
        call BJDebugMsg("增加50%增幅,20%减幅后: " + R2S(s__unitAttr_getCurrentHP(UTUnitAttr___testAttr)))
        call BJDebugMsg("当前HP倍率: " + R2S(s__unitAttr_getCurrentHPRate(UTUnitAttr___testAttr)))
    ...
    function UTUnitAttr___TTestActUTUnitAttr1 takes string str returns nothing
        ...
        if ( paramS[0] == "a" ) then // 设置基础HP
            set s__unitAttr_baseHP[UTUnitAttr___testAttr]=paramR[1]
        ...
        function UTUnitAttr___anon__3 takes nothing returns nothing
            ...
            call s__assert_Real(s__unitAttr_getCurrentHPRate(UTUnitAttr___testAttr) , 1.5 , "当前HP倍率应为1.5")
        ...
        function UTUnitAttr___anon__4 takes nothing returns nothing
            ...
            call s__assert_Real(s__unitAttr_getCurrentHPRate(UTUnitAttr___testAttr) , 0.7 , "当前HP倍率应为0.7")
        ...
        function UTUnitAttr___anon__5 takes nothing returns nothing
            ...
            call s__assert_Real(s__unitAttr_getCurrentHPRate(UTUnitAttr___testAttr) , 1.2 , "当前HP倍率应为1.2")
        ...
        function UTUnitAttr___anon__6 takes nothing returns nothing
            ...
            call s__assert_Real(s__unitAttr_getHPRateDown(UTUnitAttr___testAttr) , 0.51 , "两个30%减幅叠加后减幅值应为0.51") // 测试第三个30%减幅的叠加
            ...
            call s__assert_Real(s__unitAttr_getHPRateDown(UTUnitAttr___testAttr) , 0.657 , "三个30%减幅叠加后减幅值应为0.657")
        ...
        function UTUnitAttr___anon__7 takes nothing returns nothing
            ...
            call s__assert_Real(s__unitAttr_getHPRateDown(UTUnitAttr___testAttr) , 0.0 , "加入反向值后减幅应为0")
        ...
        function UTUnitAttr___anon__8 takes nothing returns nothing
            ...
            call s__assert_Real(s__unitAttr_getHPRateDown(UTUnitAttr___testAttr) , 0.496 , "20%,30%,10%减幅叠加后减幅值应为0.496")
        endfunction
    ...
    function UTUnitAttr___onInit takes nothing returns nothing
        ...
        call TriggerAddCondition(tr, Condition(function UTUnitAttr___anon__9))
        set tr=null
        call UnitTestRegisterChatEvent(function UTUnitAttr___anon__10)
    endfunction
...
call ExecuteFunc("jasshelper__initstructs209160125")
...
function jasshelper__initstructs209160125 takes nothing returns nothing
