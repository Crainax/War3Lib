...
function s__test_deallocate takes integer this returns nothing
    ...
    set si__test_F=this
        ...
        function UTBaseAnim___anon__0 takes integer ba returns nothing
            local integer t=UTBaseAnim___tFromBA[ba]
    ...
    function UTBaseAnim___TTestUTBaseAnim7 takes player p returns nothing
        local integer t=s__test_create()
        call s__baseanim_addSequ(s__test_ba[t],"ui\\icongrow\\ig1_" , 63 , 2 , true)
        call BJDebugMsg("测试一下序列帧，然后马上删除UI")
        call SaveInteger(HASH_TIMER, GetHandleId(ti), 1, t)
    ...
    function UTBaseAnim___TTestUTBaseAnim8 takes player p returns nothing
        ...
        function UTBaseAnim___anon__1 takes integer ba returns nothing
            local integer t=UTBaseAnim___tFromBA[ba]
            call s__test_deallocate(t)
        endfunction
    ...
    function UTBaseAnim___TTestActUTBaseAnim1 takes string str returns nothing
        ...
        function UTBaseAnim___anon__2 takes nothing returns nothing
            call BJDebugMsg("---------------------------------------")
        ...
        function UTBaseAnim___anon__3 takes nothing returns nothing
    ...
    function UTBaseAnim___onInit takes nothing returns nothing
        ...
        call TriggerAddCondition(tr, Condition(function UTBaseAnim___anon__2))
        set tr=null
        call UnitTestRegisterChatEvent(function UTBaseAnim___anon__3)
    endfunction
...
call ExecuteFunc("jasshelper__initstructs28908312")
...
function sa___prototype14_UTBaseAnim___anon__0 takes nothing returns boolean
...
function sa___prototype14_UTBaseAnim___anon__1 takes nothing returns boolean
 local integer ba=f__arg_integer1
...
function jasshelper__initstructs28908312 takes nothing returns nothing
    ...
    call TriggerAddAction(st___prototype14[1],function sa___prototype14_UTBaseAnim___anon__0)
    call TriggerAddCondition(st___prototype14[1],Condition(function sa___prototype14_UTBaseAnim___anon__0))
    set st___prototype14[2]=CreateTrigger()
    call TriggerAddAction(st___prototype14[2],function sa___prototype14_UTBaseAnim___anon__1)
    call TriggerAddCondition(st___prototype14[2],Condition(function sa___prototype14_UTBaseAnim___anon__1))
