...
//library SpellPool:
    ...
    function SpellPool__onInit takes nothing returns nothing
    endfunction
...
//library UTSpellPool:
        ...
        function UTSpellPool__anon__0 takes nothing returns nothing
            set u1=CreateUnit(Player(0), 'hfoo', 0, 0, 0)
            set u2=CreateUnit(Player(0), 'hfoo', 200, 200, 0) // 给单位添加测试技能
            call UnitAddAbility(u1, testAbility1)
            call UnitAddAbility(u1, testAbility2)
            call UnitAddAbility(u1, testAbility3)
            call UnitAddAbility(u2, testAbility1)
            call UnitAddAbility(u2, testAbility2)
            call UnitAddAbility(u2, testAbility3)
            call BJDebugMsg("测试单位已创建并添加技能")
        endfunction  // 2秒后的清理代码
        function UTSpellPool__anon__1 takes nothing returns nothing
        endfunction
        function UTSpellPool__anon__2 takes nothing returns nothing
        endfunction  //spellPool
    function UTSpellPool__Init takes nothing returns nothing
        local unit u1
        local unit u2
        local integer testAbility1='AHbz'
        local integer testAbility2='AHfs'
        local integer testAbility3='AHwe'
        call UnitTestAutoTimer(0.1 , 2.0 , function UTSpellPool__anon__0 , function UTSpellPool__anon__1)
        call UnitTestAutoTimer(0.1 , 2.0 , function UTSpellPool__anon__2 , null)
    endfunction
    function UTSpellPool__TTestUTSpellPool1 takes player p returns nothing
    endfunction
    function UTSpellPool__TTestUTSpellPool2 takes player p returns nothing
    endfunction
    function UTSpellPool__TTestUTSpellPool3 takes player p returns nothing
    endfunction
    function UTSpellPool__TTestUTSpellPool4 takes player p returns nothing
    endfunction
    function UTSpellPool__TTestUTSpellPool5 takes player p returns nothing
    endfunction
    function UTSpellPool__TTestUTSpellPool6 takes player p returns nothing
    endfunction
    function UTSpellPool__TTestUTSpellPool7 takes player p returns nothing
    endfunction
    function UTSpellPool__TTestUTSpellPool8 takes player p returns nothing
    endfunction
    function UTSpellPool__TTestUTSpellPool9 takes player p returns nothing
    endfunction
    function UTSpellPool__TTestUTSpellPool10 takes player p returns nothing
    endfunction
    function UTSpellPool__TTestActUTSpellPool1 takes string str returns nothing
        ...
        function UTSpellPool__anon__3 takes nothing returns nothing
            call Cheat("exec-lua:depends.spellpool")
            call BJDebugMsg("[SpellPool] 单元测试已加载")
            call UTSpellPool__Init()
            call DestroyTrigger(GetTriggeringTrigger())
        endfunction
        function UTSpellPool__anon__4 takes nothing returns nothing
            local string str=GetEventPlayerChatString()
            local integer i=1
            if ( SubString(str, ( 1 ) - 1, 1) == "-" ) then
                call UTSpellPool__TTestActUTSpellPool1(SubString(str, ( 2 ) - 1, StringLength(str)))
                return
            endif
            if ( str == "s1" ) then
                call UTSpellPool__TTestUTSpellPool1(GetTriggerPlayer())
            elseif ( str == "s2" ) then
                call UTSpellPool__TTestUTSpellPool2(GetTriggerPlayer())
            elseif ( str == "s3" ) then
                call UTSpellPool__TTestUTSpellPool3(GetTriggerPlayer())
            elseif ( str == "s4" ) then
                call UTSpellPool__TTestUTSpellPool4(GetTriggerPlayer())
            elseif ( str == "s5" ) then
                call UTSpellPool__TTestUTSpellPool5(GetTriggerPlayer())
            elseif ( str == "s6" ) then
                call UTSpellPool__TTestUTSpellPool6(GetTriggerPlayer())
            elseif ( str == "s7" ) then
                call UTSpellPool__TTestUTSpellPool7(GetTriggerPlayer())
            elseif ( str == "s8" ) then
                call UTSpellPool__TTestUTSpellPool8(GetTriggerPlayer())
            elseif ( str == "s9" ) then
                call UTSpellPool__TTestUTSpellPool9(GetTriggerPlayer())
            elseif ( str == "s10" ) then
                call UTSpellPool__TTestUTSpellPool10(GetTriggerPlayer())
            endif
        endfunction
    function UTSpellPool__onInit takes nothing returns nothing
        local trigger tr=CreateTrigger()
        call TriggerRegisterTimerEvent(tr, 0.5, false)
        call TriggerAddCondition(tr, Condition(function UTSpellPool__anon__3))
        set tr=null
        call UnitTestRegisterChatEvent(function UTSpellPool__anon__4)
    endfunction
...
call ExecuteFunc("jasshelper__initstructs28265671")
call ExecuteFunc("SpellPool__onInit")
call ExecuteFunc("UnitTestFramwork__onInit")
call ExecuteFunc("YDLua__onInit")
call ExecuteFunc("UTSpellPool__onInit")
...
function jasshelper__initstructs28265671 takes nothing returns nothing
