...
integer UIExtendEvent__rcStartUI=0
...
integer UTUIExtendEvent__btn=0
integer UTUIExtendEvent__img=0
...
//processed:     function interface uiEvent takes integer arg0 returns nothing  // 添加状态标记
        ...
        function UIExtendEvent__anon__5 takes nothing returns nothing
            if ( clickStartUI != 0 ) then
                set UIExtendEvent__rcStartOnUI=true
            endif // 新增的click判断逻辑
        endfunction  //注册右键抬起事件
        function UIExtendEvent__anon__6 takes nothing returns nothing
            local integer func
            if ( UIExtendEvent__rcStartOnUI and clickStartUI != 0 ) then
                if ( HaveSavedInteger(HASH_UI, clickStartUI, 1913) ) then
                    set func=LoadInteger(HASH_UI, clickStartUI, 1913)
                    call sc___prototype20_evaluate(func,clickStartUI)
                endif
            endif
        ...
        function UIExtendEvent__anon__7 takes nothing returns nothing
            ...
            local integer func
            if ( clickStartUI == ui and HaveSavedInteger(HASH_UI, ui, 1911) ) then
                set func=LoadInteger(HASH_UI, clickStartUI, 1911)
                call sc___prototype20_evaluate(func,clickStartUI)
            endif
            set clickStartUI=0
...
//library UTUIExtendEvent:
        ...
        function UTUIExtendEvent__anon__0 takes nothing returns nothing
            call BJDebugMsg("enter")
        endfunction
        function UTUIExtendEvent__anon__1 takes nothing returns nothing
            call BJDebugMsg("leave")
        endfunction
        function UTUIExtendEvent__anon__2 takes nothing returns nothing
            call BJDebugMsg("click")
        endfunction
        function UTUIExtendEvent__anon__3 takes integer frame returns nothing
            call BJDebugMsg("leftDown")
        endfunction
        function UTUIExtendEvent__anon__4 takes integer frame returns nothing
            call BJDebugMsg("leftUp")
        endfunction
    function UTUIExtendEvent__TTestUTUIExtendEvent1 takes player p returns nothing
        set UTUIExtendEvent__img=s__uiImage_texture(s__uiImage_setPoint(s__uiImage_setSize(s__uiImage_create(DzGetGameUI()),0.035 , 0.035),4 , DzGetGameUI() , 4 , 0.0 , 0.0),"ReplaceableTextures\\CommandButtons\\BTNKeeperOfTheGrove.blp")
        set UTUIExtendEvent__btn=s__uiBtn_exLeftUp(s__uiBtn_exLeftDown(s__uiBtn_onMouseClick(s__uiBtn_onMouseLeave(s__uiBtn_onMouseEnter(s__uiBtn_setAllPoint(s__uiBtn_create(DzGetGameUI()),s__uiImage_ui[UTUIExtendEvent__img]),function UTUIExtendEvent__anon__0),function UTUIExtendEvent__anon__1),function UTUIExtendEvent__anon__2),(1)),(2))
    endfunction
        function UTUIExtendEvent__anon__5 takes integer frame returns nothing
            local integer data=s__UIHashTable__uiHTEvent_get(s__uiHashTable_eventdata,frame)
            call BJDebugMsg("enter:" + I2S(data))
        endfunction
        function UTUIExtendEvent__anon__6 takes integer frame returns nothing
            local integer data=s__UIHashTable__uiHTEvent_get(s__uiHashTable_eventdata,frame)
            call BJDebugMsg("leave:" + I2S(data))
        endfunction
        function UTUIExtendEvent__anon__7 takes integer frame returns nothing
            local integer data=s__UIHashTable__uiHTEvent_get(s__uiHashTable_eventdata,frame)
            call BJDebugMsg("click:" + I2S(data))
        endfunction
        function UTUIExtendEvent__anon__8 takes integer frame returns nothing
            local integer data=s__UIHashTable__uiHTEvent_get(s__uiHashTable_eventdata,frame)
            call BJDebugMsg("RightClick:" + I2S(data))
        endfunction
    function UTUIExtendEvent__TTestUTUIExtendEvent2 takes player p returns nothing
        set UTUIExtendEvent__img=s__uiImage_texture(s__uiImage_setPoint(s__uiImage_setSize(s__uiImage_create(DzGetGameUI()),0.035 , 0.035),4 , DzGetGameUI() , 4 , 0.0 , 0.0),"ReplaceableTextures\\CommandButtons\\BTNKeeperOfTheGrove.blp")
        set UTUIExtendEvent__btn=s__uiBtn_spRightClick(s__uiBtn_spClick(s__uiBtn_spLeave(s__uiBtn_spEnter(s__uiBtn_setAllPoint(s__uiBtn_create(DzGetGameUI()),s__uiImage_ui[UTUIExtendEvent__img]),(3)),(4)),(5)),(6))
        call s__UIHashTable__uiHTEvent_bind(s__uiHashTable_eventdata,s__uiBtn_ui[UTUIExtendEvent__btn] , 8174)
    endfunction
    function UTUIExtendEvent__TTestUTUIExtendEvent3 takes player p returns nothing
    endfunction
    function UTUIExtendEvent__TTestUTUIExtendEvent4 takes player p returns nothing
    endfunction
    function UTUIExtendEvent__TTestUTUIExtendEvent5 takes player p returns nothing
    endfunction
    function UTUIExtendEvent__TTestUTUIExtendEvent6 takes player p returns nothing
    endfunction
    function UTUIExtendEvent__TTestUTUIExtendEvent7 takes player p returns nothing
    endfunction
    function UTUIExtendEvent__TTestUTUIExtendEvent8 takes player p returns nothing
    endfunction
    function UTUIExtendEvent__TTestUTUIExtendEvent9 takes player p returns nothing
    endfunction
    function UTUIExtendEvent__TTestUTUIExtendEvent10 takes player p returns nothing
    endfunction
    function UTUIExtendEvent__TTestActUTUIExtendEvent1 takes string str returns nothing
        ...
        function UTUIExtendEvent__anon__9 takes nothing returns nothing
            call BJDebugMsg("[UIExtendEvent] 单元测试已加载")
            call DestroyTrigger(GetTriggeringTrigger())
        endfunction
        function UTUIExtendEvent__anon__10 takes nothing returns nothing
            local string str=GetEventPlayerChatString()
            local integer i=1
            if ( SubStringBJ(str, 1, 1) == "-" ) then
                call UTUIExtendEvent__TTestActUTUIExtendEvent1(SubStringBJ(str, 2, StringLength(str)))
                return
            endif
            if ( str == "s1" ) then
                call UTUIExtendEvent__TTestUTUIExtendEvent1(GetTriggerPlayer())
            elseif ( str == "s2" ) then
                call UTUIExtendEvent__TTestUTUIExtendEvent2(GetTriggerPlayer())
            elseif ( str == "s3" ) then
                call UTUIExtendEvent__TTestUTUIExtendEvent3(GetTriggerPlayer())
            elseif ( str == "s4" ) then
                call UTUIExtendEvent__TTestUTUIExtendEvent4(GetTriggerPlayer())
            elseif ( str == "s5" ) then
                call UTUIExtendEvent__TTestUTUIExtendEvent5(GetTriggerPlayer())
            elseif ( str == "s6" ) then
                call UTUIExtendEvent__TTestUTUIExtendEvent6(GetTriggerPlayer())
            elseif ( str == "s7" ) then
                call UTUIExtendEvent__TTestUTUIExtendEvent7(GetTriggerPlayer())
            elseif ( str == "s8" ) then
                call UTUIExtendEvent__TTestUTUIExtendEvent8(GetTriggerPlayer())
            elseif ( str == "s9" ) then
                call UTUIExtendEvent__TTestUTUIExtendEvent9(GetTriggerPlayer())
            elseif ( str == "s10" ) then
                call UTUIExtendEvent__TTestUTUIExtendEvent10(GetTriggerPlayer())
            endif
        endfunction
    function UTUIExtendEvent__onInit takes nothing returns nothing
        local trigger tr=CreateTrigger()
        call TriggerRegisterTimerEventSingle(tr, 0.5)
        call TriggerAddCondition(tr, Condition(function UTUIExtendEvent__anon__9))
        set tr=null
        call UnitTestRegisterChatEvent(function UTUIExtendEvent__anon__10)
    endfunction
...
call ExecuteFunc("jasshelper__initstructs3204828")
...
call ExecuteFunc("UTUIExtendEvent__onInit")
...
function sa___prototype20_UTUIExtendEvent__anon__3 takes nothing returns boolean
 local integer frame=f__arg_integer1

            call BJDebugMsg("leftDown")
    return true
endfunction
function sa___prototype20_UTUIExtendEvent__anon__4 takes nothing returns boolean
 local integer frame=f__arg_integer1

            call BJDebugMsg("leftUp")
    return true
endfunction
function sa___prototype20_UTUIExtendEvent__anon__5 takes nothing returns boolean
 local integer frame=f__arg_integer1
...
function sa___prototype20_UTUIExtendEvent__anon__6 takes nothing returns boolean
 local integer frame=f__arg_integer1
...
function sa___prototype20_UTUIExtendEvent__anon__7 takes nothing returns boolean
 local integer frame=f__arg_integer1
...
function sa___prototype20_UTUIExtendEvent__anon__8 takes nothing returns boolean
 local integer frame=f__arg_integer1
...
function jasshelper__initstructs3204828 takes nothing returns nothing
    ...
    call TriggerAddAction(st___prototype20[1],function sa___prototype20_UTUIExtendEvent__anon__3)
    call TriggerAddCondition(st___prototype20[1],Condition(function sa___prototype20_UTUIExtendEvent__anon__3))
    set st___prototype20[2]=CreateTrigger()
    call TriggerAddAction(st___prototype20[2],function sa___prototype20_UTUIExtendEvent__anon__4)
    call TriggerAddCondition(st___prototype20[2],Condition(function sa___prototype20_UTUIExtendEvent__anon__4))
    set st___prototype20[3]=CreateTrigger()
    call TriggerAddAction(st___prototype20[3],function sa___prototype20_UTUIExtendEvent__anon__5)
    call TriggerAddCondition(st___prototype20[3],Condition(function sa___prototype20_UTUIExtendEvent__anon__5))
    set st___prototype20[4]=CreateTrigger()
    call TriggerAddAction(st___prototype20[4],function sa___prototype20_UTUIExtendEvent__anon__6)
    call TriggerAddCondition(st___prototype20[4],Condition(function sa___prototype20_UTUIExtendEvent__anon__6))
    set st___prototype20[5]=CreateTrigger()
    call TriggerAddAction(st___prototype20[5],function sa___prototype20_UTUIExtendEvent__anon__7)
    call TriggerAddCondition(st___prototype20[5],Condition(function sa___prototype20_UTUIExtendEvent__anon__7))
    set st___prototype20[6]=CreateTrigger()
    call TriggerAddAction(st___prototype20[6],function sa___prototype20_UTUIExtendEvent__anon__8)
    call TriggerAddCondition(st___prototype20[6],Condition(function sa___prototype20_UTUIExtendEvent__anon__8))
