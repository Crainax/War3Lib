        ...
        function s__heroAttr_getMainAttr takes unit u returns integer
            ...
            if ( IsHeroUnitId(GetUnitTypeId(u)) ) then
                if ( s__heroAttr_isExist(ha) ) then
                    return s__heroAttr_mainAttrBase[ha]
                else
...
call ExecuteFunc("jasshelper__initstructs11624250")
...
function jasshelper__initstructs11624250 takes nothing returns nothing
