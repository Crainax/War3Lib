...
//library UTMusic:
        ...
        endfunction  //music[1001] //music[13]
    function UTMusic___Init takes nothing returns nothing
        ...
        call YDUserDataSet(itemcode , 'esaz' , "LL" , integer , 23000)
    endfunction
...
call ExecuteFunc("jasshelper__initstructs7243296")
...
function jasshelper__initstructs7243296 takes nothing returns nothing
