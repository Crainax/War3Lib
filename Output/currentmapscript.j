...
constant boolean LIBRARY_UTUnitPanel=true
    uiText UTUnitPanel___testText=0
    uiText UTUnitPanel___testText2=0
    uiBtn UTUnitPanel___btnAttack=0
    uiBtn UTUnitPanel___btnArmor=0
    integer UTUnitPanel___valueAttack
    integer UTUnitPanel___valueArmor
    integer UTUnitPanel___textAttack
    integer UTUnitPanel___textArmor
    uiImage UTUnitPanel___iconAttack=0
    uiImage UTUnitPanel___iconArmor=0
...
//library UIEventModule:
    module uiEventModule  // 鼠标进入事件
        ...
        method onMouseDoubleClick takes code fun returns thistype
            ...
            return this
        endmethod  //扩展事件
        implement optional extendEvent  // optional module simpleEvent; //原生UI的事件
    endmodule
...
//library UIExtendEvent:
    ...
    function interface uiEvent takes integer arg0 returns nothing  // 是否开始右键点击
    module extendEvent  //注册按下事件,只适用于非Simple类型的
        ...
        method spRightClick takes uiEvent fun returns thistype
            ...
            return this
        endmethod  // 下面这批不适用Simple的所以全部删除了
        ...
        function UIExtendEvent___anon__3 takes nothing returns nothing  //注册左键按下事件
        ...
        function UIExtendEvent___anon__6 takes nothing returns nothing
            local uiEvent func  // 新增的click判断逻辑
            if (UIExtendEvent___rcStartOnUI and UIExtendEvent___clickStartUI!=0)then
                if (HaveSavedInteger(HASH_UI,UIExtendEvent___clickStartUI,1913))then
                    ...
                    call func.evaluate(UIExtendEvent___clickStartUI)
                endif
            endif
    ...
    function UIExtendEvent___onInit takes nothing returns nothing
        call hardware.regLeftDownEvent(function UIExtendEvent___anon__3)
        call hardware.regLeftUpEvent(function UIExtendEvent___anon__4)
        call hardware.regRightDownEvent(function UIExtendEvent___anon__5)
        call hardware.regRightUpEvent(function UIExtendEvent___anon__6)
        call uiLifeCycle.registerDestroy(function UIExtendEvent___anon__7)
...
//library UnitPanel:
    struct unitPanel extends array  //把所有原生UI移走
    //! pragma implicitthis
        static method moveOutAll takes nothing returns nothing
            local integer ui  // 攻击1
        ...
        endmethod  // 属性按钮进入事件
        static method onAttrBtnEnter takes nothing returns nothing
        endmethod
    endstruct
...
//library UIButton:
    ...
    //! pragma implicitthis
        ...
        implement  uiEventModule  // 创建一个不带声音的
        ...
        static method createSimple takes integer parent returns thistype  // parent: 父级框架
            local thistype this=allocate()
            set id=uiId.get()
            set ui=DzCreateFrameByTagName("SIMPLEBUTTON","Btn"+I2S(id),parent,"按钮模板",1)
            static if LIBRARY_UILifeCycle then
                call uiLifeCycle.onCreateCB(this,thistype.typeid,ui)
            endif
            static if LIBRARY_UIHashTable then
        ...
        static method bindSimple takes integer frame returns thistype
            local thistype this=allocate()
            set id=uiId.get()
            set ui=frame
            static if LIBRARY_UILifeCycle then
...
//library UnitTestUIRuler:
    ...
    function UnitTestUIRuler___onInit takes nothing returns nothing
        ...
        set UnitTestUIRuler___imageAnchor=uiImage.create(DzGetGameUI()).setSize(0.01,0.01).hide().setAbsPoint(4,UnitTestUIRuler___anchorPosX,UnitTestUIRuler___anchorPosY).texture("UI\\MiniMap\\minimap-gold.blp")
        set i=1
        loop
        exitwhen (i>5)
            set UnitTestUIRuler___imageRuler[i]=uiImage.create(DzGetGameUI())
            set UnitTestUIRuler___textRuler[i]=uiText.create(DzGetGameUI()).setAlign(4).hide().setText("0.000")
        set i = i+1
        endloop
        set i=1
        loop
...
//library UTUnitPanel:
        ...
        function UTUnitPanel___anon__0 takes integer frame returns nothing  //单位攻击面板（也就是跟随单位攻击1显示） 没有攻击则不显示UI //三围面板（跟随英雄三围面板，有就显示。普通单位则不显示）可以绑定英雄 // integer parent = DzSimpleFrameFindByName("SimpleInfoPanelIconHero", 6);  //英雄三围框架 // 无响应事件置父 // 响应事件置父
            call BJDebugMsg("enterAttack")
        endfunction
        function UTUnitPanel___anon__1 takes integer frame returns nothing
            call BJDebugMsg("leaveAttack")
        endfunction
        function UTUnitPanel___anon__2 takes integer frame returns nothing
            call BJDebugMsg("clickAttack")
        endfunction
        function UTUnitPanel___anon__3 takes integer frame returns nothing
            call BJDebugMsg("rightClickAttack")
        endfunction
        function UTUnitPanel___anon__4 takes integer frame returns nothing
            call BJDebugMsg("enterArmor")
        endfunction
        function UTUnitPanel___anon__5 takes integer frame returns nothing
            call BJDebugMsg("leaveArmor")
        endfunction
        function UTUnitPanel___anon__6 takes integer frame returns nothing
            call BJDebugMsg("clickArmor")
        endfunction
        function UTUnitPanel___anon__7 takes integer frame returns nothing
    ...
    function UTUnitPanel___Init takes nothing returns nothing
        ...
        set UTUnitPanel___iconAttack=uiImage.bindSimple("攻击图标",0).setSize(0.028,0.028).setPoint(3,DzFrameGetPortrait(),5,0.015,-0.01).texture("ReplaceableTextures\\CommandButtons\\BTNFrostArmor.blp")
        set UTUnitPanel___iconArmor=uiImage.bindSimple("护甲图标",0).setSize(0.028,0.028).setPoint(1,UTUnitPanel___iconAttack.ui,7,0.0,-0.005).texture("ReplaceableTextures\\CommandButtons\\BTNDarkSummoning.blp")
        set UTUnitPanel___btnAttack=uiBtn.createSimple(parent).setAllPoint(UTUnitPanel___iconAttack.ui).spEnter(UTUnitPanel___anon__0).spLeave(UTUnitPanel___anon__1).spClick(UTUnitPanel___anon__2).spRightClick(UTUnitPanel___anon__3)
        set UTUnitPanel___btnArmor=uiBtn.createSimple(parent).setAllPoint(UTUnitPanel___iconArmor.ui).spEnter(UTUnitPanel___anon__4).spLeave(UTUnitPanel___anon__5).spClick(UTUnitPanel___anon__6).spRightClick(UTUnitPanel___anon__7)
        ...
        set UTUnitPanel___testText=uiText.bindSimple("ceshinerong",0).setPoint(0,UTUnitPanel___btnAttack.ui,2,0.05,0.0).setAlign(4).setText("上内容")
        set UTUnitPanel___testText2=uiText.bindSimple("ceshinerong",1).setPoint(1,UTUnitPanel___testText.ui,7,0,-0.005).setAlign(4).setText("下内容")
        set UTUnitPanel___textAttack=uiText.bindSimple("攻击",0).clearAllPoints().setPoint(0,UTUnitPanel___btnAttack.ui,2,0,0.00).setText("攻击:")
        set UTUnitPanel___textArmor=uiText.bindSimple("护甲",0).clearAllPoints().setPoint(0,UTUnitPanel___btnArmor.ui,2,0,0.00).setText("防御:")
        set UTUnitPanel___valueAttack=uiText.bindSimple("攻击数值",0).clearAllPoints().setPoint(3,UTUnitPanel___btnAttack.ui,5,0,-0.005).setText("0")
        set UTUnitPanel___valueArmor=uiText.bindSimple("护甲数值",0).clearAllPoints().setPoint(3,UTUnitPanel___btnArmor.ui,5,0,-0.005).setText("2000")
    endfunction
    ...
    function UTUnitPanel___TTestUTUnitPanel3 takes player p returns nothing  //unitPanel.onAttrBtnEnter();
    endfunction
    ...
    function UTUnitPanel___TTestActUTUnitPanel1 takes string str returns nothing
        ...
        function UTUnitPanel___anon__8 takes nothing returns nothing  //在游戏开始0.0秒后再调用
            local unit hero
            local unit building
            local real x=0
            local real y=0
            local integer i=0  // 为玩家1创建测试英雄
    ...
    function UTUnitPanel___onInit takes nothing returns nothing
        ...
        call TriggerAddCondition(tr,Condition(function UTUnitPanel___anon__8))
        set tr=CreateTrigger()
        call TriggerRegisterTimerEventSingle(tr,0.1)
        call TriggerAddCondition(tr,Condition(function UTUnitPanel___anon__9))
        set tr=null
        call UnitTestRegisterChatEvent(function UTUnitPanel___anon__10)
