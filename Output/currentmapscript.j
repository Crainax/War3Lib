...
integer s__mouseMenu_currentMenu
integer s__mouseMenu_escStackId
...
function s__mouseMenu_deallocate takes integer this returns nothing
    ...
    set si__mouseMenu_F=this
        ...
        function s__mouseMenu_onInit takes nothing returns nothing
            ...
            call s__keyboard_regKeyDownEvent(KEY_ESC , function s__mouseMenu_anon__4)
        endfunction
...
//library UTMouseMenu:
        ...
        function UTMouseMenu__anon__0 takes nothing returns nothing
        endfunction  //end
        function UTMouseMenu__anon__1 takes nothing returns nothing
        endfunction
        function UTMouseMenu__anon__2 takes nothing returns nothing
        endfunction  //menuItem.create
    function UTMouseMenu__Init takes nothing returns nothing
        call UnitTestAutoTimer(0.1 , 2.0 , function UTMouseMenu__anon__0 , function UTMouseMenu__anon__1)
        call UnitTestAutoTimer(0.1 , 2.0 , function UTMouseMenu__anon__2 , null)
    endfunction
    ...
    function UTMouseMenu__TTestUTMouseMenu1 takes player p returns nothing
        set UTMouseMenu__menu=s__mouseMenu_create(DzGetGameUI() , true , 0.1)
        call s__mouseMenu_onEnter(UTMouseMenu__menu,(4))
        call s__mouseMenu_onClick(UTMouseMenu__menu,(5))
        call s__mouseMenu_onLeave(UTMouseMenu__menu,(6))
        call s__mouseMenu_AddMenuItem(UTMouseMenu__menu,"测试1")
        call s__mouseMenu_AddMenuItem(UTMouseMenu__menu,"测试2")
        call s__mouseMenu_AddMenuItem(UTMouseMenu__menu,"测试3")
        call s__mouseMenu_AddMenuItem(UTMouseMenu__menu,"测试4")
        call s__mouseMenu_AddMenuItem(UTMouseMenu__menu,"测试5")
        call s__uiImage_setAbsPoint(s__mouseMenu_menuFrame[UTMouseMenu__menu],4 , 0.4 , 0.3)
        call s__mouseMenu_show(UTMouseMenu__menu,true)
    endfunction
    ...
    function UTMouseMenu__TTestActUTMouseMenu1 takes string str returns nothing
        ...
        function UTMouseMenu__anon__6 takes nothing returns nothing
            call BJDebugMsg("[MouseMenu] 单元测试已加载")
            call UTMouseMenu__Init()
            call DestroyTrigger(GetTriggeringTrigger())
        endfunction
        function UTMouseMenu__anon__7 takes nothing returns nothing
    ...
    function UTMouseMenu__onInit takes nothing returns nothing
        ...
        call TriggerAddCondition(tr, Condition(function UTMouseMenu__anon__6))
        set tr=null
        call UnitTestRegisterChatEvent(function UTMouseMenu__anon__7)
    endfunction
...
call ExecuteFunc("jasshelper__initstructs30484812")
...
function sa___prototype22_UTMouseMenu__anon__3 takes nothing returns boolean
 local integer index=f__arg_integer1

            call BJDebugMsg("[进入事件] " + I2S(index))
    return true
endfunction
function sa___prototype22_UTMouseMenu__anon__4 takes nothing returns boolean
 local integer index=f__arg_integer1

            call BJDebugMsg("[点击事件] " + I2S(index))
    return true
endfunction
function sa___prototype22_UTMouseMenu__anon__5 takes nothing returns boolean
 local integer index=f__arg_integer1
...
function jasshelper__initstructs30484812 takes nothing returns nothing
    ...
    call TriggerAddAction(st___prototype22[4],function sa___prototype22_UTMouseMenu__anon__3)
    call TriggerAddCondition(st___prototype22[4],Condition(function sa___prototype22_UTMouseMenu__anon__3))
    set st___prototype22[5]=CreateTrigger()
    call TriggerAddAction(st___prototype22[5],function sa___prototype22_UTMouseMenu__anon__4)
    call TriggerAddCondition(st___prototype22[5],Condition(function sa___prototype22_UTMouseMenu__anon__4))
    set st___prototype22[6]=CreateTrigger()
    call TriggerAddAction(st___prototype22[6],function sa___prototype22_UTMouseMenu__anon__5)
    call TriggerAddCondition(st___prototype22[6],Condition(function sa___prototype22_UTMouseMenu__anon__5))
