...
static integer rcStartPos = 0; // 右键点击开始时的鼠标位置
        ...
        static method inside (integer row,integer col) {
            DzFrameClearAllPoints(grid[row][col]);
            DzFrameSetPoint(grid[row][col], 4, DzGetGameUI(), 5, - 0.3078 + (0.0398 * row), - 0.165 - (0.0385 * col));
        }
        static method onInit() {
            integer row;
            integer col;
            ...
            DzFrameSetScriptByCode(grid[1][1],2,function () {mousePos = ((1-1)*4)+1;if(trEnter != null) {argsRow = 1;argsCol = 1;TriggerEvaluate(trEnter);}},false); 
 DzFrameSetScriptByCode(grid[1][1],3,function () {mousePos = 0;if(trLeave != null) {argsRow = 1;argsCol = 1;TriggerEvaluate(trLeave);}},false); 
 DzFrameSetScriptByCode(grid[1][1],1,function () {if(trClick != null) {argsRow = 1;argsCol = 1;TriggerEvaluate(trClick);}},false);
            DzFrameSetScriptByCode(grid[1][2],2,function () {mousePos = ((1-1)*4)+2;if(trEnter != null) {argsRow = 1;argsCol = 2;TriggerEvaluate(trEnter);}},false); 
 DzFrameSetScriptByCode(grid[1][2],3,function () {mousePos = 0;if(trLeave != null) {argsRow = 1;argsCol = 2;TriggerEvaluate(trLeave);}},false); 
 DzFrameSetScriptByCode(grid[1][2],1,function () {if(trClick != null) {argsRow = 1;argsCol = 2;TriggerEvaluate(trClick);}},false);
            DzFrameSetScriptByCode(grid[1][3],2,function () {mousePos = ((1-1)*4)+3;if(trEnter != null) {argsRow = 1;argsCol = 3;TriggerEvaluate(trEnter);}},false); 
 DzFrameSetScriptByCode(grid[1][3],3,function () {mousePos = 0;if(trLeave != null) {argsRow = 1;argsCol = 3;TriggerEvaluate(trLeave);}},false); 
 DzFrameSetScriptByCode(grid[1][3],1,function () {if(trClick != null) {argsRow = 1;argsCol = 3;TriggerEvaluate(trClick);}},false);
            DzFrameSetScriptByCode(grid[1][4],2,function () {mousePos = ((1-1)*4)+4;if(trEnter != null) {argsRow = 1;argsCol = 4;TriggerEvaluate(trEnter);}},false); 
 DzFrameSetScriptByCode(grid[1][4],3,function () {mousePos = 0;if(trLeave != null) {argsRow = 1;argsCol = 4;TriggerEvaluate(trLeave);}},false); 
 DzFrameSetScriptByCode(grid[1][4],1,function () {if(trClick != null) {argsRow = 1;argsCol = 4;TriggerEvaluate(trClick);}},false);
            DzFrameSetScriptByCode(grid[2][1],2,function () {mousePos = ((2-1)*4)+1;if(trEnter != null) {argsRow = 2;argsCol = 1;TriggerEvaluate(trEnter);}},false); 
 DzFrameSetScriptByCode(grid[2][1],3,function () {mousePos = 0;if(trLeave != null) {argsRow = 2;argsCol = 1;TriggerEvaluate(trLeave);}},false); 
 DzFrameSetScriptByCode(grid[2][1],1,function () {if(trClick != null) {argsRow = 2;argsCol = 1;TriggerEvaluate(trClick);}},false);
            DzFrameSetScriptByCode(grid[2][2],2,function () {mousePos = ((2-1)*4)+2;if(trEnter != null) {argsRow = 2;argsCol = 2;TriggerEvaluate(trEnter);}},false); 
 DzFrameSetScriptByCode(grid[2][2],3,function () {mousePos = 0;if(trLeave != null) {argsRow = 2;argsCol = 2;TriggerEvaluate(trLeave);}},false); 
 DzFrameSetScriptByCode(grid[2][2],1,function () {if(trClick != null) {argsRow = 2;argsCol = 2;TriggerEvaluate(trClick);}},false);
            DzFrameSetScriptByCode(grid[2][3],2,function () {mousePos = ((2-1)*4)+3;if(trEnter != null) {argsRow = 2;argsCol = 3;TriggerEvaluate(trEnter);}},false); 
 DzFrameSetScriptByCode(grid[2][3],3,function () {mousePos = 0;if(trLeave != null) {argsRow = 2;argsCol = 3;TriggerEvaluate(trLeave);}},false); 
 DzFrameSetScriptByCode(grid[2][3],1,function () {if(trClick != null) {argsRow = 2;argsCol = 3;TriggerEvaluate(trClick);}},false);
            DzFrameSetScriptByCode(grid[2][4],2,function () {mousePos = ((2-1)*4)+4;if(trEnter != null) {argsRow = 2;argsCol = 4;TriggerEvaluate(trEnter);}},false); 
 DzFrameSetScriptByCode(grid[2][4],3,function () {mousePos = 0;if(trLeave != null) {argsRow = 2;argsCol = 4;TriggerEvaluate(trLeave);}},false); 
 DzFrameSetScriptByCode(grid[2][4],1,function () {if(trClick != null) {argsRow = 2;argsCol = 4;TriggerEvaluate(trClick);}},false);
            DzFrameSetScriptByCode(grid[3][1],2,function () {mousePos = ((3-1)*4)+1;if(trEnter != null) {argsRow = 3;argsCol = 1;TriggerEvaluate(trEnter);}},false); 
 DzFrameSetScriptByCode(grid[3][1],3,function () {mousePos = 0;if(trLeave != null) {argsRow = 3;argsCol = 1;TriggerEvaluate(trLeave);}},false); 
 DzFrameSetScriptByCode(grid[3][1],1,function () {if(trClick != null) {argsRow = 3;argsCol = 1;TriggerEvaluate(trClick);}},false);
            DzFrameSetScriptByCode(grid[3][2],2,function () {mousePos = ((3-1)*4)+2;if(trEnter != null) {argsRow = 3;argsCol = 2;TriggerEvaluate(trEnter);}},false); 
 DzFrameSetScriptByCode(grid[3][2],3,function () {mousePos = 0;if(trLeave != null) {argsRow = 3;argsCol = 2;TriggerEvaluate(trLeave);}},false); 
 DzFrameSetScriptByCode(grid[3][2],1,function () {if(trClick != null) {argsRow = 3;argsCol = 2;TriggerEvaluate(trClick);}},false);
            DzFrameSetScriptByCode(grid[3][3],2,function () {mousePos = ((3-1)*4)+3;if(trEnter != null) {argsRow = 3;argsCol = 3;TriggerEvaluate(trEnter);}},false); 
 DzFrameSetScriptByCode(grid[3][3],3,function () {mousePos = 0;if(trLeave != null) {argsRow = 3;argsCol = 3;TriggerEvaluate(trLeave);}},false); 
 DzFrameSetScriptByCode(grid[3][3],1,function () {if(trClick != null) {argsRow = 3;argsCol = 3;TriggerEvaluate(trClick);}},false);
            DzFrameSetScriptByCode(grid[3][4],2,function () {mousePos = ((3-1)*4)+4;if(trEnter != null) {argsRow = 3;argsCol = 4;TriggerEvaluate(trEnter);}},false); 
 DzFrameSetScriptByCode(grid[3][4],3,function () {mousePos = 0;if(trLeave != null) {argsRow = 3;argsCol = 4;TriggerEvaluate(trLeave);}},false); 
 DzFrameSetScriptByCode(grid[3][4],1,function () {if(trClick != null) {argsRow = 3;argsCol = 4;TriggerEvaluate(trClick);}},false);
            hardware.regRightDownEvent(function () { //注册右键按下事件
