...
constant integer si__UTSpell___spell=5
integer si__UTSpell___spell_F=0
integer si__UTSpell___spell_I=0
integer array si__UTSpell___spell_V
integer array si__UTSpell___spell_2V
integer array si__UTSpell___spell_3V
integer array s__UTSpell___spell_2id
integer array s__UTSpell___spell_3id
integer array s__UTSpell___spell_id
integer array s__UTSpell___spell_2level
integer array s__UTSpell___spell_3level
integer array s__UTSpell___spell_level
integer array s__UTSpell___spell_2sdId
integer array s__UTSpell___spell_3sdId
integer array s__UTSpell___spell_sdId
constant integer si__unitSelect=6
...
function sg__UTSpell___spell_get_id takes integer i returns integer
    if(i<8191) then
        return s__UTSpell___spell_id[i]
    elseif(i<16382) then
        return s__UTSpell___spell_2id[i-8191]
    else
        return s__UTSpell___spell_3id[i-16382]
    endif
endfunction

function sg__UTSpell___spell_set_id takes integer i,integer v returns nothing
    if(i<8191) then
        set s__UTSpell___spell_id[i]=v
    elseif(i<16382) then
        set s__UTSpell___spell_2id[i-8191]=v
    else
        set s__UTSpell___spell_3id[i-16382]=v
    endif
endfunction

function sg__UTSpell___spell_get_level takes integer i returns integer
    if(i<8191) then
        return s__UTSpell___spell_level[i]
    elseif(i<16382) then
        return s__UTSpell___spell_2level[i-8191]
    else
        return s__UTSpell___spell_3level[i-16382]
    endif
endfunction

function sg__UTSpell___spell_set_level takes integer i,integer v returns nothing
    if(i<8191) then
        set s__UTSpell___spell_level[i]=v
    elseif(i<16382) then
        set s__UTSpell___spell_2level[i-8191]=v
    else
        set s__UTSpell___spell_3level[i-16382]=v
    endif
endfunction

function sg__UTSpell___spell_get_sdId takes integer i returns integer
    if(i<8191) then
        return s__UTSpell___spell_sdId[i]
    elseif(i<16382) then
        return s__UTSpell___spell_2sdId[i-8191]
    else
        return s__UTSpell___spell_3sdId[i-16382]
    endif
endfunction

function sg__UTSpell___spell_set_sdId takes integer i,integer v returns nothing
    if(i<8191) then
        set s__UTSpell___spell_sdId[i]=v
    elseif(i<16382) then
        set s__UTSpell___spell_2sdId[i-8191]=v
    else
        set s__UTSpell___spell_3sdId[i-16382]=v
    endif
endfunction
...
//Generated allocator of UTSpell___spell
function s__UTSpell___spell__allocate takes nothing returns integer
 local integer this=si__UTSpell___spell_F
    if (this!=0) then
        if(this<8191) then
            set si__UTSpell___spell_F=si__UTSpell___spell_V[this]
        elseif(this<16382) then
            set si__UTSpell___spell_F=si__UTSpell___spell_2V[this-8191]
        else
            set si__UTSpell___spell_F=si__UTSpell___spell_3V[this-16382]
        endif
    else
        set si__UTSpell___spell_I=si__UTSpell___spell_I+1
        set this=si__UTSpell___spell_I
    endif
    if (this>20000) then
        call DisplayTimedTextToPlayer(GetLocalPlayer(),0,0,1000.,"Unable to allocate id for an object of type: UTSpell___spell")
        return 0
    endif

    if(this<8191) then
        set si__UTSpell___spell_V[this]=-1
    elseif(this<16382) then
        set si__UTSpell___spell_2V[this-8191]=-1
    else
        set si__UTSpell___spell_3V[this-16382]=-1
    endif
 return this
endfunction

//Generated destructor of UTSpell___spell
function s__UTSpell___spell_deallocate takes integer this returns nothing
 local integer used
    if this==null then
            call DisplayTimedTextToPlayer(GetLocalPlayer(),0,0,1000.,"Attempt to destroy a null struct of type: UTSpell___spell")
        return
    else
        if(this<8191) then
            set used=si__UTSpell___spell_V[this]
        elseif(this<16382) then
            set used=si__UTSpell___spell_2V[this-8191]
        else
            set used=si__UTSpell___spell_3V[this-16382]
        endif
        if (used!=-1) then
            call DisplayTimedTextToPlayer(GetLocalPlayer(),0,0,1000.,"Double free of type: UTSpell___spell")
            return
        endif
    endif
    if(this<8191) then
        set si__UTSpell___spell_V[this]=si__UTSpell___spell_F
    elseif(this<16382) then
        set si__UTSpell___spell_2V[this-8191]=si__UTSpell___spell_F
    else
        set si__UTSpell___spell_3V[this-16382]=si__UTSpell___spell_F
    endif
    set si__UTSpell___spell_F=this
endfunction
...
call ExecuteFunc("jasshelper__initstructs27689140")
...
function jasshelper__initstructs27689140 takes nothing returns nothing
