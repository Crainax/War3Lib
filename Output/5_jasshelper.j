...
//library UTUnitAttr:
    ...
    function UTUnitAttr___TTestActUTUnitAttr1 takes string str returns nothing
        ...
        elseif ( paramS[0] == "atkspd" ) then // 攻击速度相关命令 // 增加基础攻击速度
            ...
            call BJDebugMsg("当前攻击速度: " + R2S(s__unitAttr_getCurrentAtkSpeed(UTUnitAttr___testAttr)))
        elseif ( paramS[0] == "atkspddown" ) then // 设置攻击速度减速比例
            call s__unitAttr_addAtkSpdDown(UTUnitAttr___testAttr,paramR[1])
            call BJDebugMsg("攻击速度百分比减少: " + R2S(paramR[1]))
            call BJDebugMsg("当前攻击速度: " + R2S(s__unitAttr_getCurrentAtkSpeed(UTUnitAttr___testAttr)))
        ...
        elseif ( paramS[0] == "atkinterval" ) then // 攻击间隔相关命令 // 增加基础攻击间隔
            ...
            call BJDebugMsg("当前攻击间隔: " + R2S(s__unitAttr_getCurrentAtkInterval(UTUnitAttr___testAttr)))
...
call ExecuteFunc("jasshelper__initstructs29888453")
...
function jasshelper__initstructs29888453 takes nothing returns nothing
