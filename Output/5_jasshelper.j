...
function s__toastPop_deallocate takes integer this returns nothing
    ...
    set si__toastPop_F=this
        ...
        function s__toastPop_initBase takes integer this,player p returns integer
            ...
            set s__toastPop_bg[this]=s__uiImage_setAbsPoint(s__uiImage_setSize(s__uiImage_setTexture(s__uiImage_create(DzGetGameUI()),"ui\\image\\BG_PopUI.blp"),0.3 , 0.3 / resizeX * 0.29032),7 , .4 , .1375)
            return this
        ...
        function s__toastPop_createWithIcon takes player p,string iconPath,string contentText returns integer
            ...
            set s__toastPop_icon[this]=s__uiImage_setPoint(s__uiImage_setSize(s__uiImage_setTexture(s__uiImage_create(s__uiImage_ui[s__toastPop_bg[this]]),iconPath),0.03 , 0.03 / resizeX),1 , s__uiImage_ui[s__toastPop_bg[this]] , 1 , 0 , - 0.012 / resizeX)
            set s__toastPop_content[this]=s__uiText_setText(s__uiText_setPoint(s__uiText_setPoint(s__uiText_setPoint(s__uiText_setPoint(s__uiText_create(s__uiImage_ui[s__toastPop_bg[this]]),1 , s__uiImage_ui[s__toastPop_icon[this]] , 7 , 0 , - 0.007 / resizeX),7 , s__uiImage_ui[s__toastPop_bg[this]] , 7 , 0 , 0.005),3 , s__uiImage_ui[s__toastPop_bg[this]] , 3 , 0.01 , 0),5 , s__uiImage_ui[s__toastPop_bg[this]] , 5 , - 0.01 , 0),contentText) // 创建内容文本
        ...
        function s__toastPop_createWithTitle takes player p,string titleText,string contentText returns integer
            ...
            set s__toastPop_title[this]=s__uiText_setPoint(s__uiText_setText(s__uiText_create(s__uiImage_ui[s__toastPop_bg[this]]),titleText),1 , s__uiImage_ui[s__toastPop_bg[this]] , 1 , 0 , - 0.018 / resizeX)
            set s__toastPop_content[this]=s__uiText_setText(s__uiText_setPoint(s__uiText_setPoint(s__uiText_setPoint(s__uiText_setPoint(s__uiText_create(s__uiImage_ui[s__toastPop_bg[this]]),1 , s__uiText_ui[s__toastPop_title[this]] , 7 , 0 , - 0.007 / resizeX),7 , s__uiImage_ui[s__toastPop_bg[this]] , 7 , 0 , 0.005),3 , s__uiImage_ui[s__toastPop_bg[this]] , 3 , 0.01 , 0),5 , s__uiImage_ui[s__toastPop_bg[this]] , 5 , - 0.01 , 0),contentText) // 创建内容文本
            return sc__toastPop_initAnimation(this,0.3 , 5.0)
...
call ExecuteFunc("jasshelper__initstructs28991703")
...
function jasshelper__initstructs28991703 takes nothing returns nothing
