...
constant integer si__keyboard=6
    ...
    function UTUnitTestUIRuler___TTestActUTUnitTestUIRuler1 takes string str returns nothing
        ...
        function UTUnitTestUIRuler___anon__1 takes nothing returns nothing
            ...
            if ( SubString(str, ( 1 ) - 1, 1) == "-" ) then
                call UTUnitTestUIRuler___TTestActUTUnitTestUIRuler1(SubString(str, ( 2 ) - 1, StringLength(str)))
                return
            endif
            if ( str == "s1" ) then
...
call ExecuteFunc("jasshelper__initstructs23862812")
...
function jasshelper__initstructs23862812 takes nothing returns nothing
