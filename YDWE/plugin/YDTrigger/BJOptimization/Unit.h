...
#  define GetUnitLifePercent(unit)                               GetUnitStatePercent(unit, UNIT_STATE_LIFE, UNIT_STATE_MAX_LIFE)
#  define GetUnitManaPercent(unit)                               GetUnitStatePercent(unit, UNIT_STATE_MANA, UNIT_STATE_MAX_MANA)
