...
library UTAbilityDecorate requires AbilityDecorate {
    ...
    SetAbilityDecorateCornerText(testHero2, 'AHbn', "Y");
		...
		BJDebugMsg("|cFFFFCC00[AbilityDecorate]|r 已为两个英雄的技能设置装饰");
		BJDebugMsg("|cFFFFCC00[AbilityDecorate]|r 选中英雄可查看技能装饰效果");
	}
	...
	function TTestUTAbilityDecorate1 (player p) {
        ...
        if (u != null) {
            ...
            BJDebugMsg("|cFF00FF00[测试1]|r 已为火焰呼吸技能添加装饰");
        }
		abil = null; u = null;
	}
	...
	function TTestUTAbilityDecorate2 (player p) {
        ...
        if (u != null) {
            ...
            BJDebugMsg("|cFF00FF00[测试2]|r 已移除霜冻闪电技能的装饰");
        }
		abil = null; u = null;
	}
	...
	function TTestUTAbilityDecorate3 (player p) {
        ...
        if (u != null) {
            ...
            BJDebugMsg("|cFF00FF00[测试3]|r 已修改变形术技能的装饰");
        }
		abil = null; u = null;
	}
	...
	function TTestUTAbilityDecorate4 (player p) {
		...
		BJDebugMsg("|cFF00FF00[测试4]|r 已批量设置6个技能的装饰");
		abil = null; u = null;
	}
	...
	function TTestUTAbilityDecorate5 (player p) {
        ...
        if (u != null) {
            ...
            BJDebugMsg("|cFF00FF00[测试5]|r 已为暴风雪技能设置自定义图标");
        }
		abil = null; u = null;
	}
	...
	function TTestUTAbilityDecorate6 (player p) {
        ...
        if (u != null) {
            ...
            BJDebugMsg("|cFF00FF00[测试6]|r 已为水元素技能设置流光效果");
        }
		abil = null; u = null;
	}
	...
	function TTestUTAbilityDecorate7 (player p) {
        ...
        if (u != null) {
            ...
            BJDebugMsg("|cFF00FF00[测试7]|r 已为闪现技能设置角落文字");
        }
		abil = null; u = null;
	}
	...
	function TTestUTAbilityDecorate8 (player p) {
		if (testHero1 != null && testHero2 != null) {
			...
			BJDebugMsg("|cFF00FF00[测试8]|r 已切换到第一个英雄，查看技能装饰");
		}
	}
	...
	function TTestUTAbilityDecorate9 (player p) {
		...
		BJDebugMsg("|cFF00FF00[测试9]|r 已清除当前英雄所有技能的装饰");
		abil = null; u = null;
	}
	...
	function TTestUTAbilityDecorate10 (player p) {
		Init();
		BJDebugMsg("|cFF00FF00[测试10]|r 已重新初始化所有技能装饰");
		//YDWEId2S
	}
	...
	function onInit () {
		...
		TriggerAddCondition(tr,Condition(function (){
			...
			BJDebugMsg("[AbilityDecorate] 单元测试已加载");
			...
			BJDebugMsg("|cFFFFCC00[AbilityDecorate]|r 已创建两个测试英雄：大法师和血法师");
			BJDebugMsg("|cFFFFCC00[AbilityDecorate]|r 选中英雄可测试技能装饰效果");
